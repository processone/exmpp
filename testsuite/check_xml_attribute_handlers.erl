...
do_check() ->
	...
	test_get_attribute2(),
	test_get_attribute3(),
	test_set_attribute_from_list3(),
	test_set_attribute_from_list4(),
	test_set_attribute3(),
	test_set_attribute4(),
...
test_set_attribute_from_list3() ->
	New1 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST1,
	    "lang", "en"),
	testsuite:is(New1, [
	    {xmlattr, undefined, undefined, "lang", "en"}
	]),
	New2_1 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST2_1,
	    "xml:lang", "en"),
	testsuite:is(New2_1, [
	    {"version", "1.0"},
	    {"xml:lang","en"}
	]),
	New2_2 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST2_2,
	    "xml:lang", "en"),
	testsuite:is(New2_2, [
	    {"version", "1.0"},
	    {"xml:lang","en"}
	]),
	New3_1 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST3_1,
	    "lang", "en"),
	testsuite:is(New3_1, [
	    {xmlattr, undefined, undefined, "version", "1.0"},
	    {xmlattr, undefined, undefined, "lang", "en"}
	]),
	New3_2 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST3_2,
	    "lang", "en"),
	testsuite:is(New3_2, [
	    {xmlattr, undefined, undefined, "version", "1.0"},
	    {xmlattr, ?XML_NS, undefined, "lang", "en"}
	]),
	New4 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST4,
	    "lang", "en"),
	testsuite:is(New4, [
	    bad_data,
	    {xmlattr, undefined, undefined, "lang", "en"}
...
test_set_attribute_from_list4() ->
	...
	New3_3 = exmpp_xml:set_attribute_from_list(?ATTRIBUTE_LIST3_2,
