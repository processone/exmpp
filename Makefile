RECURSIVE_TARGETS = all-recursive check-recursive \
	install-data-recursive install-recursive \
	installdirs-recursive uninstall-recursive
...
clean: clean-recursive clean-tags

.MAKE: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) install-am \
	install-strip

.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) \
	all check clean clean-generic \
	clean-tags ctags ctags-recursive dist dist-all dist-bzip2 \
	dist-gzip dist-lzma dist-zip distcheck \
