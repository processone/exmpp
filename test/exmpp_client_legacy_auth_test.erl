...
request_with_user_test() ->
	...
	?assertEqual(?NS_LEGACY_AUTH, 
		exml:get_path(R, [{element, <<"query">>}, {attribute, <<"xmlns">>}])),
	?assertEqual(<<"user">>,
		exml:get_path(R, [{element, <<"query">>}, {element, <<"username">>},cdata])),
	ok.
...
password_test() ->
	...
	?assertEqual(<<"resource">>, exml:get_path(R, [{element, <<"query">>}, {element, <<"resource">>}, cdata])),
	ok.
...
password_digest_test() ->
	...
	?assertEqual(<<"48fc78be9ec8f86d8ce1c39c320c97c21d62334d">>, 
		exml:get_path(R, [{element, <<"query">>}, {element, <<"digest">>}, cdata])),
	ok.
