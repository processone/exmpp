...
info_test() ->
	...
	?assertEqual(<<"domain.com">>, exxml:get_attr(R, <<"to">>, undefined)),
	...
	?assertEqual(<<"get">>, exxml:get_attr(R2, <<"type">>, undefined)),
	?assertEqual(<<"domain.com">>, exxml:get_attr(R2, <<"to">>, undefined)),
	?assertEqual(<<"http://jabber.org/protocol/disco#info">>, 
