...
feature_test() ->
	...
	?assertEqual(<<"urn:ietf:params:xml:ns:xmpp-tls">>, exxml:get_attribute(B, <<"xmlns">>)),
	?assertMatch([{xmlel, <<"required">>, _, _}], exxml:get_elements(exmpp_server_tls:feature(true))),
	ok.
